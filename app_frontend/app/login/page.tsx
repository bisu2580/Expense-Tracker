...
const Login = () => {
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
      ...
      {/* Floating Theme Toggle - Desktop top-left/right, mobile top-right */}
      <div className="absolute top-6 right-6 z-50">
        <ThemeToggle />
      </div>

      {/* Left Column: Login Form */}
      <div className="flex-1 flex flex-col justify-center px-6 py-12 md:px-12 lg:px-20 xl:px-24 bg-white dark:bg-zinc-950 lg:max-w-2xl xl:max-w-3xl z-10 shadow-[20px_0_40px_rgba(0,0,0,0.01)] border-r border-zinc-200/50 dark:border-zinc-900/50">
        ...
        <div className="mx-auto w-full max-w-md flex flex-col gap-8">
          ...
          <Link href="/" className="flex items-center gap-2.5 group w-fit">
            ...
            <h1 className="text-lg font-bold tracking-tight text-zinc-900 dark:text-zinc-50">
              Expense<span className="text-primary font-extrabold ml-0.5">Tracker</span>
            </h1>
          </Link>
          ...
          <div className="grid grid-cols-2 gap-3.5">
            ...
            >
              {/* GitHub SVG */}
              <svg className="h-4.5 w-4.5 fill-current text-zinc-800 dark:text-zinc-200" viewBox="0 0 24 24">
          ...
          <div className="flex justify-between items-center text-xs text-zinc-400 dark:text-zinc-500 mt-2">
      ...
      {/* Right Column: App Showcase (Hidden on Mobile) */}
      <div className="hidden lg:flex flex-1 relative items-center justify-center bg-zinc-900 dark:bg-zinc-950 overflow-hidden">
        
        {/* Glow Effects / Decorative Gradients */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-primary/20 blur-3xl -mr-40 -mt-40 z-0 animate-pulse duration-[6000ms]" />
        ...
        <div className="relative z-10 w-full max-w-lg px-8 flex flex-col gap-10 py-6">
          ...
          <div className="flex flex-col gap-4 text-center lg:text-left">
            ...
            <p className="text-zinc-400 text-sm xl:text-base leading-relaxed">
              Connect accounts, set dynamic budgets, and view high-fidelity reports instantly. Built for people who care about visual financial control.
            </p>
          </div>
          ...
          <div className="relative flex flex-col gap-2">
            ...
            {/* Card 1: Balance Showcase */}
            <div className="bg-zinc-950/60 backdrop-blur-xl border border-zinc-800/80 rounded-2xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.5)] transform -rotate-2 hover:rotate-0 transition-transform duration-500">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-xxs font-semibold text-zinc-500 uppercase tracking-wider">Available Balance</p>
                  <p className="text-2xl font-extrabold text-white mt-1">$14,285.50</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3.5 mt-5">
                <div className="bg-zinc-900/60 border border-zinc-800/50 p-3 rounded-xl flex flex-col gap-1">
                  <div className="flex items-center gap-1.5 text-emerald-400 font-semibold text-[10px] bg-emerald-500/10 px-1.5 py-0.5 rounded-full w-max">
                    <TrendingUp className="h-2.5 w-2.5" />
                    +12.4%
                  </div>
                  <p className="text-lg font-bold text-white mt-1">$8,450.00</p>
                  <p className="text-[10px] text-zinc-500">Monthly Revenue</p>
                </div>
                <div className="bg-zinc-900/60 border border-zinc-800/50 p-3 rounded-xl flex flex-col gap-1">
                  <div className="flex items-center gap-1.5 text-primary font-semibold text-[10px] bg-primary/10 px-1.5 py-0.5 rounded-full w-max">
                    <PiggyBank className="h-2.5 w-2.5" />
                    Goal: $5k
                  </div>
                  <p className="text-lg font-bold text-white mt-1">$3,200.00</p>
                  <p className="text-[10px] text-zinc-500">Total Savings</p>
                </div>
              </div>
            </div>

            {/* Card 2: Floating Transaction Preview */}
            <div className="absolute right-[-20px] top-[140px] w-72 bg-zinc-950/80 backdrop-blur-xl border border-zinc-800/80 rounded-2xl p-4 shadow-[0_20px_40px_rgba(0,0,0,0.6)] transform rotate-3 hover:rotate-0 transition-all duration-500 hidden xl:block">
              ...
              <div className="flex items-center justify-between p-2 hover:bg-zinc-900/50 rounded-lg">
                <div className="flex items-center gap-2.5">
                  <div className="w-7.5 h-7.5 rounded-lg bg-primary/10 text-primary flex items-center justify-center">
                    <CreditCard className="h-3.5 w-3.5" />
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-zinc-200">Apple Store</p>
                    <p className="text-[9px] text-zinc-500">iCloud Storage</p>
                  </div>
                </div>
                <span className="text-xs font-bold text-zinc-200">-$9.99</span>
              </div>
            </div>

            {/* Card 3: Budget usage progress bar */}
            <div className="bg-zinc-950/60 backdrop-blur-xl border border-zinc-800/80 rounded-2xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.4)] transform rotate-1 hover:rotate-0 transition-transform duration-500">
              <div className="flex flex-col gap-2.5">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-zinc-400 font-medium">Monthly Budget Spent</span>
                  <span className="text-primary font-bold">64% ($2,880 of $4,500)</span>
                </div>
          ...
          {/* <div className="border-t border-zinc-800 pt-6 flex flex-col gap-3">
            <p className="text-zinc-400 text-xs italic leading-relaxed">
              &ldquo;ExpenseTracker has completely transformed how I monitor my business expenditures. It&apos;s beautiful, lightning fast, and lets me customize categories dynamically.&rdquo;
            </p>
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-white">Julianne Davis</p>
                <p className="text-[10px] text-zinc-500">Co-Founder, Design Co</p>
              </div>
            </div>
          </div> */}
